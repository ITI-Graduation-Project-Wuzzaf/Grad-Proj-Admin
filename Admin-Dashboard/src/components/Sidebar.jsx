...
const Sidebar = () => {
  ...
  if (
    ...
    return (
      ...
      >
        <div className="content-center justify-between text-left md:mt-16 md:w-48 md:fixed md:left-0 md:top-0 md:content-start">
          <ul className="flex flex-row px-1 py-0 text-center list-reset md:flex-col md:py-3 md:px-2 md:text-left">
            <li className="flex-1 mr-3">
              ...
              >
                ...
                {/* <span className="block pb-1 text-xsmd:pb-0 md:text-base md:text-gray-400 md:inline-block"> */}
                Employers
                {/* </span> */}
              </NavLink>
            </li>
            ...
            <li className="flex-1 mr-3">
              <NavLink
                ...
                // className="block py-1 pl-1 text-white no-underline align-middle border-b-2 border-blue-600 md:py-3 hover:text-white"
              >
